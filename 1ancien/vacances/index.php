...
#cache{position:absolute; top:0; right:0; left:0; bottom:0; background-color:white; z-index:200; opacity:0.7; display:none;}
.centrale{position:absolute; top:10px; right:1%; left:1%; bottom:10px; z-index:300; opacity:1; display:none; text-align:center;}
...
<?php 
	...
	<section>
		<div class='titre'>
			<h1>Vacancier</h1>
			<a href='./?album=Alentours' class='cible'>Région</a>
...
foreach($photos as $donnee) {
	...
	echo "<img class='exit cible' src='../images/croix.png' width=10 onclick='cachage(".$donnee['id'].");'>
				<h2>".$alb."</h2>
				<table width='100%'>
					<td class='fleche_gauche fleche cible'><img src='../images/flechega.png' width='30' onclick='revelation(".$donnee['pre_id'].");'></td>
					<td class='image_principale'><img height=400 src=../".$donnee['photo'].">
						<form method='post' action='ajout_photo.php'>
					...
					<td class='fleche_droite fleche cible'><img src='../images/flechedr.png' width='30' onclick='revelation(".$donnee['post_id'].");'></td>
				</table>
			</div>";
}
